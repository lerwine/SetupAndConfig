...
declare namespace $$rhino {
     ...
     * @typedef {(T extends string ? T | null | undefined | EmptyString : T | null | undefined)} Nilable<T>
     ...
     * @template S - Type of value that is to include {@link EmptyString} values.
     */
     export type IncludeEmptyString<S> = S | EmptyString;

    /**
     * Conditional type that excludes empty javascript primitive string values and zero-length {@link Packages.java.lang.String} objects.
     * @typedef {(S extends EmptyString ? never : S)} ExcludeEmptyJavaString<S>
     ...
     * @typedef {(N | Packages.java.lang.Number | S)} NumberLike<N, S>
     * @template N - The JavaScript number type.
     ...
     * @template S - Type of JavaScript string value.
     */
    export type StringValue<S extends string> = S | Packages.java.lang.String;

    /**
     * Utility type to represent Java arrays.
     *
     * @interface IJavaArray<E>
     * @extends {Packages.java.util.List<E>}
     * @template E - The array element type
     */
     export interface IJavaArray<E> extends Packages.java.util.List<E> {
        /**
...
/**
 * Basic Java object type definitions.
 * @namespace Packages
 */
    ...
    export namespace java {
        ...
        export namespace util {
            ...
            export interface Collection<E> extends Iterable<E> {
                 ...
                 */
                toArray(a: $$rhino.IJavaArray<E>): $$rhino.IJavaArray<E>;
            }
